  ...
  const handleNotificationPress = async (notification: Notification) => {
    ...
    router.push({
      ...
      params: {
        ...
        staticDistance: notification.data.staticDistance?.toString() || '',
        isNearActive: notification.data.isNearActive?.toString() || '',
        activeLat: notification.data.activeLat?.toString() || '',
        activeLon: notification.data.activeLon?.toString() || '',
